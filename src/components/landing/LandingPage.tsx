    ...
    <div className="flex-1 flex flex-col justify-center gap-10 py-4">
      ...
      <section className="flex flex-col items-center text-center gap-8">
        <div className="flex flex-col gap-5">
          <h1 className="text-4xl lg:text-6xl font-bold text-white tracking-tight flex flex-col gap-3">
      ...
      <section className="flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl w-full">
          <div className="rounded-lg border border-dashed border-gray-200 bg-zinc-800/40 p-6 flex flex-col gap-2 text-center">
